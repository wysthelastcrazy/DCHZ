...
public class HeaderDetailView extends RelativeLayout implements OnClickListener{
	...
	public void initKey(String str){
		...
		//请假申请
			...
			text_item1_key.setText("借 款 人：");
			text_item2_key.setText("借款部门：");
			text_item3_key.setText("借款时间：");
		...
		}else if(Common.FUKUAN.equals(str)){
			text_title.setText("付款申请");
