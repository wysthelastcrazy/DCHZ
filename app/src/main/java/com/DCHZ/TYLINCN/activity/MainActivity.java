...
public class MainActivity extends TabActivity implements OnClickListener{
	...
	public static LinearLayout linear_btn_group;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		linear_btn_group=(LinearLayout) findViewById(R.id.linear_btn_group);
		line=findViewById(R.id.line);
		initTab();
	}
	public static final void hideTab(){
		linear_btn_group.setVisibility(View.GONE);
		line.setVisibility(View.GONE);
	}
	public static final void show(){
		linear_btn_group.setVisibility(View.VISIBLE);
