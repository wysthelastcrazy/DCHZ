...
public class HttpEngine extends Thread{
	...
	private String defultTestIp="192.168.1.2:8001";
	private String testIp="";
	private String defultIp="mobile.mis.tylin.com.cn:9080";
	private String ip="";
	private HttpEngine() {
...
//			return "http://"+testIp+"/DCMobileWebService/MobileService.asmx";
//		}else{
//			SharePreIPUtil.saveIpInfo(defultTestIp);
//			return "http://"+defultTestIp+"/DCMobileWebService/MobileService.asmx";
//		}
		if(!TextUtils.isEmpty(ip)){
			return "https://"+ip+"/DCMobileWebService/MobileService.asmx";
		}else{
			SharePreIPUtil.saveIpInfo(defultTestIp);
			return "https://"+defultIp+"/DCMobileWebService/MobileService.asmx";
		}
	}
}
